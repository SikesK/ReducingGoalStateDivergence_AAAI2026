...
do
  ...
  do
   ...
   for copy in {1..5}
    ...
    #gtimeout 60m python compiled_model_for_zero_minimal_design.py -h_d ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/human_domain.pddl  -h_i  ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/human_problem.pddl -r_d ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/robot_domain.pddl  -r_i ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/robot_problem.pddl  -d_c ${no_of_designs} #> ./experiment_scripts_for_aaai_24/LOGS_main/Exhaustive_${domain}_${prob}_5_main_${no_of_designs}_Copy${copy}.txt

    gtimeout 60m python compiled_model_for_zero_but_with_exhaustive_search.py -h_d ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/human_domain.pddl  -h_i  ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/human_problem.pddl -r_d ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/robot_domain.pddl  -r_i ../domain/benchmarks/AAAI_23_Domains/${domain}/ground_prob${prob}${copy}/robot_problem.pddl  -d_c ${no_of_designs} > ./experiment_scripts_for_aaai_24/LOGS_main/Exhaustive_${domain}_${prob}_5_main_${no_of_designs}_Copy${copy}.txt
  done
done
done
done
