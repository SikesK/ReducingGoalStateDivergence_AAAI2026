...
def find_max_gsd(path_to_human_domain, path_to_human_problem, path_to_robot_domain, path_to_robot_problem, designs, max_div_budget):
    #calculate the max gsd for the given problem pair
...
if __name__ == '__main__':
    ...
    for budget in range(10, number_of_predicate + 20 , 20):
